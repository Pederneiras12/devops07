...
dhcpd:
  subnets:
    172.20.123.0:
      ...
      routers:
        - 172.20.123.1
      broadcast_address: 172.20.123.255
      subnet-mask: 255.255.255.0
      next_server: 172.20.123.254
...
nfs:
    nfs_server: 172.20.123.254

P2K-POS:
    ip: 172.20.123.131
    num_loja: 0408
    pdv: 031
    gateway: 172.20.123.1
    rede: 172.20.123.0
    cnpj: 96662168040001
    estado: SC
    ip_sp: 172.20.123.254
