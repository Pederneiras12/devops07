...
dhcpd:
  subnets:
    172.20.121.0:
      ...
      routers:
        - 172.20.121.1
      broadcast_address: 172.20.121.255
      subnet-mask: 255.255.255.0
      next_server: 172.20.121.254
...
nfs:
    nfs_server: 172.20.121.254

P2K-POS:
    ip: 172.20.121.131
    num_loja: 0406
    pdv: 031
    gateway: 172.20.121.1
    rede: 172.20.121.0
    cnpj: 96662168039852
    estado: SC
    ip_sp: 172.20.121.254
