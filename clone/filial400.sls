...
dhcpd:
  subnets:
    172.20.115.0:
      ...
      routers:
        - 172.20.115.1
      broadcast_address: 172.20.115.255
      subnet-mask: 255.255.255.0
      next_server: 172.20.115.254
...
nfs:
    nfs_server: 172.20.115.254

P2K-POS:
    ip: 172.20.115.131
    num_loja: 0400
    pdv: 031
    gateway: 172.20.115.1
    rede: 172.20.115.0
    cnpj: 96662168039429
    estado: RS
    ip_sp: 172.20.115.254
