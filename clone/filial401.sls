...
dhcpd:
  subnets:
    172.20.116.0:
      ...
      routers:
        - 172.20.116.1
      broadcast_address: 172.20.116.255
      subnet-mask: 255.255.255.0
      next_server: 172.20.116.254
...
nfs:
    nfs_server: 172.20.116.254

P2K-POS:
    ip: 172.20.116.131
    num_loja: 0401
    pdv: 031
    gateway: 172.20.116.1
    rede: 172.20.116.0
    cnpj: 96662168040354
    estado: RS
    ip_sp: 172.20.116.254
