...
dhcpd:
  subnets:
    172.20.108.0:
      ...
      routers:
        - 172.20.108.1
      broadcast_address: 172.20.108.255
      subnet-mask: 255.255.255.0
      next_server: 172.20.108.254
...
nfs:
    nfs_server: 172.20.108.254

P2K-POS:
    ip: 172.20.108.131
    num_loja: 0393
    pdv: 031
    gateway: 172.20.108.1
    rede: 172.20.108.0
    cnpj: 96662168039500
    estado: SC
    ip_sp: 172.20.108.254
